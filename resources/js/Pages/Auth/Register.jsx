...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center py-8 px-4"
            ...
            <div className="w-full max-w-xl bg-white rounded-none shadow-2xl overflow-hidden"
                ...
                <div className="px-8 pt-10 pb-10">
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6" autoComplete="off">
                        {/* Hidden Honeypot */}
                        ...
                        <div className="md:col-span-2 space-y-2">
                            <label htmlFor="full_name" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>الاسم الكامل</label>
                            <input type="text" id="full_name" name="full_name" value={formData.full_name} onChange={handleChange} required
                                className="w-full px-8 py-8 text-xl bg-gray-50 border-2 border-transparent rounded-none outline-none transition-all duration-300 font-bold focus:bg-white"
                                style={{ border: `1px solid ${PRUSSIAN}15` }}
                                placeholder="أدخل اسمك الكامل" autoComplete="name" />
                        </div>

                        <div className="space-y-2">
                            <label htmlFor="username" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>اسم المستخدم</label>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="email" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>البريد الإلكتروني</label>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="password" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>كلمة المرور</label>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="role" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>نوع الحساب</label>
                            <select id="role" name="role" value={formData.role} onChange={handleChange}
                                className="w-full px-8 py-8 text-xl bg-gray-50 border-2 border-transparent rounded-none outline-none transition-all duration-300 font-black text-gray-700"
                                style={{ border: `1px solid ${PRUSSIAN}15` }}>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="affiliation" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>الجهة / الجامعة</label>
                        ...
                        <div className="space-y-2">
                            <label htmlFor="phone" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>رقم الهاتف</label>
                        ...
                        <div className="md:col-span-2 space-y-2">
                            <label htmlFor="bio" className="text-xl font-['Cairo'] font-black uppercase tracking-widest mr-1" style={{ color: PRUSSIAN }}>نبذة تعريفية</label>
                            <textarea id="bio" name="bio" value={formData.bio} onChange={handleChange} rows="2"
                                className="w-full px-8 py-8 text-xl bg-gray-50 border-2 border-transparent rounded-none outline-none transition-all duration-300 font-bold focus:bg-white resize-none"
                                style={{ border: `1px solid ${PRUSSIAN}15` }}
