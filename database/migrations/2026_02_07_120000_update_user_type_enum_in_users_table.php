...
return new class extends Migration {
    ...
    {
        // Check if we are using MySQL before executing the MySQL-specific MODIFY COLUMN statement.
        // On PostgreSQL, the initial users table migration already contains all roles,
        // and MODIFY COLUMN syntax is not supported.
